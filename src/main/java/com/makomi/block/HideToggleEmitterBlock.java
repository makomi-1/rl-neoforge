 ...
 * </p>
 */
public class HideToggleEmitterBlock extends LinkToggleEmitterBlock {
	public HideToggleEmitterBlock(BlockBehaviour.Properties properties) {
		super(properties);
	...
	protected LinkTriggerSourceBlockEntity createEmitterBlockEntity(BlockPos blockPos, BlockState blockState) {
		return new HideToggleEmitterBlockEntity(blockPos, blockState);
	}
