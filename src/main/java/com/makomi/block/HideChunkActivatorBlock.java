 ...
 * 隐藏区块激活器。
 * <p>
 * 仍然执行真实区块激活逻辑，但默认隐藏，且需佩戴智能眼镜才能命中与编辑。
 * </p>
 */
public class HideChunkActivatorBlock extends LinkChunkActivatorBlock {
	public static final MapCodec<HideChunkActivatorBlock> CODEC = simpleCodec(HideChunkActivatorBlock::new);

	public HideChunkActivatorBlock(BlockBehaviour.Properties properties) {
		super(properties);
	...
	public BlockEntity newBlockEntity(BlockPos blockPos, BlockState blockState) {
		return new HideChunkActivatorBlockEntity(blockPos, blockState);
	}
